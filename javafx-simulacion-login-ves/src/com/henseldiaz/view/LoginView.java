 ...
 */
package com.henseldiaz.view;

import com.henseldiaz.controller.ImageController;
...
public class LoginView extends BorderPane {
    ...
    private String RUTA_ESTILOS = "/com/henseldiaz/styles/";
    ...
    private LoginView() {
        ...
        this.setBorder(new Border(
                new BorderStroke( Paint.valueOf("#00C9D4"),
        ...
        lblTituloVenta = new Label("JAVAFX - SIMULACION LOGIN");
        
        barraDeOpciones.getChildren().addAll(btnCerrarVentana, lblTituloVenta);
    ...
    public Label getLblTituloVenta() {
        return lblTituloVenta;
    }

    public void setLblTituloVenta(Label lblTituloVenta) {
        this.lblTituloVenta = lblTituloVenta;
    }
